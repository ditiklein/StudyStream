...
//         userId: isAuthenticated ? user.id : 1, // שנה מ-undefined ל-null
...
//             <Typography variant="h5" color="text.secondary" sx={{ maxWidth: 600, mx: 'auto', lineHeight: 1.6, mt: 3 }}>
...
import { AppDispatch } from '../FileAndFolderStore/FileStore';
import { selectMessages } from '../FileAndFolderStore/MessageSlice';
import { theme } from './Theme';
import HelpSupportHeader from './HelpSupportHeader';
import ContactForm from './ContactForm';
import HelpSupportFooter from './HelpSupportFooter';
