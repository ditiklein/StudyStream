...
{
    /// <inheritdoc />
    public partial class clever : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedWithEmail = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    AccessRequestToken = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedLessons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedLessons_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedLessons_LessonId",
                table: "SharedLessons",
                column: "LessonId");
