...
//using DotNetEnv;
//using Microsoft.EntityFrameworkCore;
//using Microsoft.AspNetCore.HttpOverrides; // הוספה חדשה
...
//{
//    options.AddPolicy("AllowFrontend", policy =>
//        policy.WithOrigins("http://localhost:5173", "http://localhost:4200", "https://studystream-rgv5.onrender.com")
//              .AllowAnyMethod()
//              .AllowAnyHeader()
//              .AllowCredentials()
//    );
...
//// הגדרת ForwardedHeaders עבור Render
...
//// הגדרת Forwarded Headers - חשוב מאוד עבור Render!
...
//    app.UseSwaggerUI();
//    app.UseDeveloperExceptionPage();
//    app.UseHttpsRedirection(); // רק ב-development
//}
//else
//{
//    // ב-production (Render) - אל תשתמש ב-HTTPS redirection
//    app.UseSwagger();
//    app.UseSwaggerUI();
//    // אפשר להוסיף error handling נוסף כאן
//}
